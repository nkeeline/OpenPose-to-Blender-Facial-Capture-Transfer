...
head_bone =  DestArm.pose.bones["c_head.x"]
jaw_bone =  DestArm.pose.bones["c_jawbone.x"]
#lower_face =  DestArm.pose.bones["lowerFaceRig"]
lower_lip_center =  DestArm.pose.bones["c_lips_bot.x"]
upper_lip_center =  DestArm.pose.bones["c_lips_top.x"]
lower_lip_center_l =  DestArm.pose.bones["c_lips_bot.l"]
lower_lip_center_r =  DestArm.pose.bones["c_lips_bot.r"]
upper_lip_center_l =  DestArm.pose.bones["c_lips_top.l"]
upper_lip_center_r =  DestArm.pose.bones["c_lips_top.r"]

upper_lip_outer_r =  DestArm.pose.bones["c_lips_top_01.r"]
lower_lip_outer_r =  DestArm.pose.bones["c_lips_bot_01.r"]
upper_lip_outer_l =  DestArm.pose.bones["c_lips_top_01.l"]
lower_lip_outer_l =  DestArm.pose.bones["c_lips_bot_01.l"]

corner_lip_r =  DestArm.pose.bones["c_lips_smile.r"]
Corner_lip_l =  DestArm.pose.bones["c_lips_smile.l"]


eyebrow_outer_r =  DestArm.pose.bones["c_eyebrow_03.r"]
eyebrow_center_r =  DestArm.pose.bones["c_eyebrow_01.r"]
eyebrow_center_r2 =  DestArm.pose.bones["c_eyebrow_02.r"]
eyebrow_inner_r =  DestArm.pose.bones["c_eyebrow_01_end.r"]

eyebrow_outer_l =  DestArm.pose.bones["c_eyebrow_03.l"]
eyebrow_center_l =  DestArm.pose.bones["c_eyebrow_01.l"]
eyebrow_center_l2 =  DestArm.pose.bones["c_eyebrow_02.l"]
eyebrow_inner_l =  DestArm.pose.bones["c_eyebrow_01_end.l"]

eyelid_l =  DestArm.pose.bones["c_eyelid_top.l"]
eyelid_r =  DestArm.pose.bones["c_eyelid_top.r"]

eyelid_lower_l =  DestArm.pose.bones["c_eyelid_bot_02.l"]
eyelid_lower_r =  DestArm.pose.bones["c_eyelid_bot_02.r"]
...
#        lower_face.rotation_euler.x = math.radians(p1.getJawTiltUpDown())
        ...
        if (CurrentFrame % mouth_KeyFrame_Every_Nth_Frame == 0) and (keyFrame):
            ...
            jaw_bone.keyframe_insert(data_path='location',frame= StartFrameNumber + CurrentFrame)
        ...
        if (CurrentFrame % eyes_KeyFrame_Every_Nth_Frame == 0) and (keyFrame):
            ...
            eyebrow_center_l2.keyframe_insert(data_path='location',frame= StartFrameNumber + CurrentFrame)
            ...
            eyebrow_center_r2.keyframe_insert(data_path='location',frame= StartFrameNumber + CurrentFrame)
